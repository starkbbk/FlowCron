          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 rounded-3xl" style={{ gap: '40px' }}>
            ...
            <div className="md:col-span-2 mac-bento-card flex flex-col items-center justify-center min-h-[320px] p-16 lg:p-20 gap-8 text-center">
              ...
              <div className="space-y-4 max-w-sm">
                <h3 className="text-[24px] font-black text-white tracking-tight">Visual Logic Builder</h3>
                <p className="text-[15px] text-[#86868b] leading-relaxed font-medium opacity-80">
            ...
            <div className="md:col-span-1 mac-bento-card flex flex-col items-center justify-center min-h-[320px] p-14 lg:p-16 gap-6 text-center">
              ...
              <div className="space-y-4 max-w-xs">
                <h3 className="text-[20px] font-black text-white tracking-tight">Smart Schedulers</h3>
                <p className="text-[14px] text-[#86868b] leading-relaxed font-medium opacity-80">
            ...
            <div className="md:col-span-1 mac-bento-card flex flex-col items-center justify-center min-h-[320px] p-14 lg:p-16 gap-6 text-center">
              ...
              <div className="space-y-4 max-w-xs">
                <h3 className="text-[20px] font-black text-white tracking-tight">Real-time Data</h3>
                <p className="text-[14px] text-[#86868b] leading-relaxed font-medium opacity-80">
            ...
            <div className="md:col-span-2 mac-bento-card flex flex-col items-center justify-center relative overflow-hidden min-h-[320px] p-16 lg:p-20 gap-8 text-center">
              ...
              <div className="space-y-4 relative z-10 max-w-sm">
                <h3 className="text-[24px] font-black text-white tracking-tight">Connect Anything</h3>
                <p className="text-[15px] text-[#86868b] leading-relaxed font-medium opacity-80">
                 ...
                 {[
                  ...
                  <div key={idx} className="flex gap-8 group items-start p-10 hover:bg-white/5 rounded-[32px] transition-all border border-transparent hover:border-white/10 cursor-pointer">
                      ...
                      <div className="space-y-3">
                        <div className="text-[18px] font-black text-white tracking-tight">{item.title}</div>
                        <div className="text-[15px] text-[#86868b] font-medium leading-relaxed opacity-80">{item.desc}</div>
                      </div>
                   </div>
                 ))}
              </div>
